...
class TextLineSorter extends React.Component {
  state = {
    input: 'World\nHello',
    output: '',
  };
  ...
  render() {
    ...
    const tool = Tool.allTools.textLineSorter;
...
TextLineSorter.propTypes = {
  classes: PropTypes.object.isRequired,
  enqueueSnackbar: PropTypes.func.isRequired,
};

const App = withStyles(styles)(withSnackbar(TextLineSorter));
